...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpaceConfig.openSensor'
        db.add_column('local_spaceconfig', 'openSensor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sensors.Sensor'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpaceConfig.openSensor'
        db.delete_column('local_spaceconfig', 'openSensor_id')
