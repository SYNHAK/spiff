...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'membership_membershipperiod', (
            ...
            ('activeFromDate', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 1, 31, 0, 0))),
            ('activeToDate', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 1, 31, 0, 0))),
            ('lineItem', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['membership.RankLineItem'])),
        ))
        db.send_create_signal(u'membership', ['MembershipPeriod'])


        # Changing field 'RankSubscriptionPlan.subscriptionplan_ptr'
        db.alter_column(u'membership_ranksubscriptionplan', u'subscriptionplan_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['subscription.SubscriptionPlan'], unique=True, primary_key=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'RankSubscriptionPlan.subscriptionplan_ptr'
        db.alter_column(u'membership_ranksubscriptionplan', u'subscriptionplan_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['payment.SubscriptionPlan'], unique=True, primary_key=True))
    ...
    models = {
        ...
        u'membership.membershipperiod': {
            ...
            'activeFromDate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 31, 0, 0)'}),
            'activeToDate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 31, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lineItem': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['membership.RankLineItem']"}),
