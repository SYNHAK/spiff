...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rank.isActiveMembership'
        db.add_column('membership_rank', 'isActiveMembership',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'DuePayment.created'
        db.alter_column('membership_duepayment', 'created', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting field 'Rank.isActiveMembership'
        db.delete_column('membership_rank', 'isActiveMembership')


        # Changing field 'DuePayment.created'
        db.alter_column('membership_duepayment', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
