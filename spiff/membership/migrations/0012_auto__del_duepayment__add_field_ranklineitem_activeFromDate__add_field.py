...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RankLineItem.activeFromDate'
        db.add_column('membership_ranklineitem', 'activeFromDate',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 2, 0, 0)),
                      keep_default=False)

        # Adding field 'RankLineItem.activeToDate'
        db.add_column('membership_ranklineitem', 'activeToDate',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 2, 0, 0)),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'RankLineItem.activeFromDate'
        db.delete_column('membership_ranklineitem', 'activeFromDate')

        # Deleting field 'RankLineItem.activeToDate'
        db.delete_column('membership_ranklineitem', 'activeToDate')
    ...
    models = {
        ...
        'membership.ranklineitem': {
            ...
            'activeFromDate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 2, 0, 0)'}),
            'activeToDate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 2, 0, 0)'}),
