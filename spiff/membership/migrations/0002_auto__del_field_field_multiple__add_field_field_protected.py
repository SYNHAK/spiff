...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Field.multiple'
        db.delete_column('membership_field', 'multiple')

        # Adding field 'Field.protected'
        db.add_column('membership_field', 'protected',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Field.multiple'
        db.add_column('membership_field', 'multiple',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Field.protected'
        db.delete_column('membership_field', 'protected')
