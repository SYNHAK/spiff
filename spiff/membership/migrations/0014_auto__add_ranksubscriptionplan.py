...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'membership.ranklineitem': {
            ...
            'activeFromDate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 27, 0, 0)'}),
            'activeToDate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 27, 0, 0)'}),
        ...
        u'membership.ranksubscriptionplan': {
            'Meta': {'object_name': 'RankSubscriptionPlan', '_ormbases': [u'payment.SubscriptionPlan']},
