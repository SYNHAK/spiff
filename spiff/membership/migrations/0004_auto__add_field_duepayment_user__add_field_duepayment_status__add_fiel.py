...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DuePayment.user'
        db.add_column('membership_duepayment', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'DuePayment.status'
        db.add_column('membership_duepayment', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DuePayment.transactionID'
        db.add_column('membership_duepayment', 'transactionID',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DuePayment.user'
        db.delete_column('membership_duepayment', 'user_id')

        # Deleting field 'DuePayment.status'
        db.delete_column('membership_duepayment', 'status')

        # Deleting field 'DuePayment.transactionID'
        db.delete_column('membership_duepayment', 'transactionID')
