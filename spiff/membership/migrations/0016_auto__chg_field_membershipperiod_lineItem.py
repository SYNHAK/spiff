...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MembershipPeriod.lineItem'
        db.alter_column(u'membership_membershipperiod', 'lineItem_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['membership.RankLineItem'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MembershipPeriod.lineItem'
        raise RuntimeError("Cannot reverse this migration. 'MembershipPeriod.lineItem' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'MembershipPeriod.lineItem'
        db.alter_column(u'membership_membershipperiod', 'lineItem_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['membership.RankLineItem']))
    ...
    models = {
        ...
        u'membership.membershipperiod': {
            ...
            'activeFromDate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 27, 0, 0)'}),
            'activeToDate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 27, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
