...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('membership_ranklineitem', (
            ('lineitem_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['payment.LineItem'], unique=True, primary_key=True)),
        ...
        db.send_create_signal('membership', ['RankLineItem'])


    def backwards(self, orm):
        # Deleting model 'RankLineItem'
        db.delete_table('membership_ranklineitem')
    ...
    models = {
        ...
        'membership.ranklineitem': {
            ...
            'member': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['membership.Member']"}),
