...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Payment', fields ['user']
        db.delete_unique('payment_payment', ['user_id'])


        # Changing field 'Payment.user'
        db.alter_column('payment_payment', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Payment.user'
        db.alter_column('payment_payment', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'Payment', fields ['user']
        db.create_unique('payment_payment', ['user_id'])
