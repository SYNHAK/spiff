...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('payment_linediscountitem', (
        ...
        db.send_create_signal('payment', ['LineDiscountItem'])


    def backwards(self, orm):
        # Deleting model 'LineDiscountItem'
        db.delete_table('payment_linediscountitem')
    ...
    models = {
        ...
        'payment.linediscountitem': {
            'Meta': {'object_name': 'LineDiscountItem'},
            'description': ('django.db.models.fields.TextField', [], {}),
            'flatRate': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'discounts'", 'to': "orm['payment.Invoice']"}),
            'lineItem': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'discounts'", 'to': "orm['payment.LineItem']"}),
